...
for i in range(8):
        ...
        grupo.clear()
print("Lista de grupos:",lista_grupos)
print(" ")
...
def puntaje(probabilidad):
    ...
    if probabilidad > 0.5:
        ...
        return (contador+1)
print(probabilidad(dicc["Nigeria"],dicc["Croacia"]))
#puntaje
...
print("CLASIFICADOS:",lista_octavos)
...
print("CLASIFICADOS:", lista_cuartos)
...
print("CLASIFICADOS:", lista_final)
